...
public class AddTies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_ties);

        // Initialize Firebase storage and database references
        storageReference = FirebaseStorage.getInstance().getReference().child("ties");
        wrappersReference = FirebaseDatabase.getInstance().getReference("ties");
    ...
    private void uploadWrapper() {
        ...
        if (imageUri != null && !priceString.isEmpty()) {
            ...
            StorageReference fileReference = storageReference.child(shopName).child("ties" + System.currentTimeMillis() + ".jpg");
            ...
            fileReference.putFile(imageUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        fileReference.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            uploadties wrapper = new uploadties(shopName, uri.toString(), price, "Available" );
                            ...
                            Toast.makeText(AddTies.this, "Wrapper added successfully", Toast.LENGTH_SHORT).show();
                            finish();
                        });
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(AddTies.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        } else {
