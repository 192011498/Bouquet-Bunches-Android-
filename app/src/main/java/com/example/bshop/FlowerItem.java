...
public class FlowerItem extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {

    LinearLayout FlowerItemContainer;
    String shopName;
    String username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FlowerItemContainer = findViewById(R.id.coversContainer);
        ...
        // Show all FlowerItem for the specific shop
        showFlowerItemForShop();
    ...
    private void showFlowerItemForShop() {
        if (shopName == null || shopName.isEmpty()) {
            // Handle the case where shopName is not available
            Log.e("FlowerItem", "ShopName is null or empty");
            return;
        }

        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("flowers").child(shopName);

        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.d("FlowerItem", "Querying FlowerItem for shop: " + shopName);

                if (!snapshot.exists()) {
                    // No data found for the specific shop
                    Log.e("FlowerItem", "No data found for FlowerItem in shop: " + shopName);
                    return;
                }

                Log.d("FlowerItem", "Number of entries found for FlowerItem in shop " + shopName + ": " + snapshot.getChildrenCount());

                for (DataSnapshot FlowerItemSnapshot : snapshot.getChildren()) {
                    Log.d("FlowerItem", "Processing entry for FlowerItem");

                    String imageUrl = FlowerItemSnapshot.child("imageUrl").getValue(String.class);
                    String availability = FlowerItemSnapshot.child("availability").getValue(String.class);
                    int price = FlowerItemSnapshot.child("price").getValue(Integer.class);


                    if (imageUrl != null && !imageUrl.isEmpty()) {
                        Log.d("FlowerItem", "Image URL: " + imageUrl);

                        // Inflate the item_cover.xml layout
                        View coverItemView = getLayoutInflater().inflate(R.layout.item_wrapper, FlowerItemContainer, false);
                        ...
                        deleteButton2.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(FlowerItem.this);
                                ...
                                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        DatabaseReference wrapperRef = FirebaseDatabase.getInstance().getReference("flowers")
                                                .child(shopName).child(FlowerItemSnapshot.getKey());
                                        ...
                                        wrapperRef.removeValue()
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        FlowerItemContainer.removeView(coverItemView);
                        ...
                        // Add the inflated layout to the FlowerItemContainer
                        FlowerItemContainer.addView(coverItemView);
                    } else {
                        Log.e("FlowerItem", "Image URL is null or empty for an entry");
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("FlowerItem", "Database error: " + error.getMessage());
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.action_home) {
            Intent profileIntent = new Intent(FlowerItem.this, sellHome.class);
            startActivity(profileIntent);
        } else if (itemId == R.id.action_profile) {
            // Handle profile icon click
            Intent profileIntent = new Intent(FlowerItem.this, ProfileActivity2.class);

            startActivity(profileIntent);
        } else if (itemId == R.id.action_orders) {
            Intent profileIntent = new Intent(FlowerItem.this, sellOrders.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_add_wrappers) {
                    ...
                    Intent addWrapperIntent = new Intent(FlowerItem.this, addWrapper.class);

                    startActivity(addWrapperIntent);
                    return true;
                } else if (itemId == R.id.menu_view_wrappers) {
                    Intent viewWrappersIntent = new Intent(FlowerItem.this, WrapperItem.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_logout) {
                    Intent logoutIntent = new Intent(FlowerItem.this, home.class);
                    startActivity(logoutIntent);
                    return true;
                } else if (itemId == R.id.menu_add_flowers) {
                    Intent viewWrappersIntent = new Intent(FlowerItem.this, AddFlowers.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_view_flowers) {
                    Intent logoutIntent = new Intent(FlowerItem.this, FlowerItem.class);
                    startActivity(logoutIntent);
                    return true;
                }else if (itemId == R.id.menu_add_ties) {
                    Intent viewWrappersIntent = new Intent(FlowerItem.this, AddTies.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_view_ties) {
                    Intent logoutIntent = new Intent(FlowerItem.this, TiesItem.class);
                    startActivity(logoutIntent);
                    return true;
                }
                else {
    ...
    private void reloadFlowerItems() {
        FlowerItemContainer.removeAllViews(); // Clear existing items
