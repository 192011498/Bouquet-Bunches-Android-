...
public class customize14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedFlowerIds.isEmpty()) {
                    ...
                    Toast.makeText(customize14.this, "Please select at least one flower.", Toast.LENGTH_SHORT).show();
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addressIntent = new Intent(customize14.this, Address.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot flowerSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (flower != null && "Available".equals(flower.getAvailability())) {
                                ...
                                ImageView flowerImageView = new ImageView(customize14.this);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot tieSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (tie != null && "Available".equals(tie.getAvailability())) {
                                ...
                                ImageView tieImageView = new ImageView(customize14.this);
    ...
    private void addFlowerToPreview(String imageUrl, int price, String flowerName) {
        ...
        int top = dpToPx(25) + random.nextInt(dpToPx(75) - dpToPx(25) + 1);
        int left = dpToPx(40) + random.nextInt(dpToPx(140) - dpToPx(40) + 1);
