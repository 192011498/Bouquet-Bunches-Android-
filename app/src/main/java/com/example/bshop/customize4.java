...
public class customize4 extends AppCompatActivity {
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedFlowerIds.isEmpty()) {
                    ...
                    Toast.makeText(customize4.this, "Please select at least one flower.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot flowerSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (flower != null && "Available".equals(flower.getAvailability())) {
                                ...
                                ImageView flowerImageView = new ImageView(customize4.this);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot tieSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (tie != null && "Available".equals(tie.getAvailability())) {
                                ...
                                ImageView tieImageView = new ImageView(customize4.this);
    ...
    private void addFlowerToPreview(String imageUrl, int price, String flowerName) {
        ...
        int top = dpToPx(60) + random.nextInt(dpToPx(170) - dpToPx(60) + 1);
        int left = dpToPx(30) + random.nextInt(dpToPx(170) - dpToPx(30) + 1);
