...
public class customize8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedFlowerIds.isEmpty()) {
                    ...
                    Toast.makeText(customize8.this, "Please select at least one flower.", Toast.LENGTH_SHORT).show();
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addressIntent = new Intent(customize8.this, Address.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot flowerSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (flower != null && "Available".equals(flower.getAvailability())) {
                                ...
                                ImageView flowerImageView = new ImageView(customize8.this);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot tieSnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (tie != null && "Available".equals(tie.getAvailability())) {
                                ...
                                ImageView tieImageView = new ImageView(customize8.this);
    ...
    private void addFlowerToPreview(String imageUrl, int price, String flowerName) {
        ...
        int top = dpToPx(50) + random.nextInt(dpToPx(100) - dpToPx(50) + 1);
