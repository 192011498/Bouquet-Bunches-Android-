        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_add_wrappers) {
                    ...
                    Intent addWrapperIntent = new Intent(sellOrders.this, addWrapper.class);

                    startActivity(addWrapperIntent);
                    return true;
                } else if (itemId == R.id.menu_view_wrappers) {
                    Intent viewWrappersIntent = new Intent(sellOrders.this, WrapperItem.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_logout) {
                    Intent logoutIntent = new Intent(sellOrders.this, home.class);
                    startActivity(logoutIntent);
                    return true;
                } else if (itemId == R.id.menu_add_flowers) {
                    Intent viewWrappersIntent = new Intent(sellOrders.this, AddFlowers.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_view_flowers) {
                    Intent logoutIntent = new Intent(sellOrders.this, FlowerItem.class);
                    startActivity(logoutIntent);
                    return true;
                }else if (itemId == R.id.menu_add_ties) {
                    Intent viewWrappersIntent = new Intent(sellOrders.this, AddTies.class);

                    startActivity(viewWrappersIntent);
                    return true;
                } else if (itemId == R.id.menu_view_ties) {
                    Intent logoutIntent = new Intent(sellOrders.this, TiesItem.class);
                    startActivity(logoutIntent);
                    return true;
                }
                else {
